...
// TODO UPDATED : Modèle mis à jour
...
/* ------------- NEW MODELS TO FINALIZE ------------- */

// TODO : Remove after migrating to calendar-utils
...
// TODO : En attendant de l'écrire dans Calendar Utils
...
// TODO : Remove after migrating to calendar-utils and combining ResourceCalendarEvent new properties in CalendarEvent
...
function getResourceWeekViewHourGrid<EventMetaType, ResourceMetaType>(
  ...
  setResourcesMaxRowsNumber: Function
    ...
    const getDayEventsGroupedByResource = (
      ...
      return combinedResourceList.map(
        (
          ...
          let resourcesMaxRowsNumberItem =
            resourcesMaxRowsNumber[resourceIndex];
          let isCountGreaterThanPrevious =
